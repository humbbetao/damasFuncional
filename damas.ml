...
let rec moverY hd peca i j x y  =
	match hd with
		| [] -> []
...
let turno jogador  =  if  (jogador mod 2 ) = 0 then print_string "Turno do Jogador "  else print_string "Turno do Computador";;
